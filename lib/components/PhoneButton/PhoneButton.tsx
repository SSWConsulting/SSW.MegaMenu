  ...
  return (
    ...
    >
      <CustomLink
        href={url}
        className={cx(
          "flex h-12 w-full shrink-0 cursor-pointer items-center justify-center rounded bg-ssw-red px-4 text-xl hover:opacity-70 max-sm:my-5 sm:w-fit whitespace-nowrap",
        )}
      >
